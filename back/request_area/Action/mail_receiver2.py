...
"""
    ...
    Programme get last mail with the key_word_subjetc
"""
...
class Mailer2():
    ...
    def start(self, key_word = "Récapitulatif de vos frais bancaires en 2020"):
        try:
...
def main():
    try:
        info = Mailer("benjamin.rugby69@gmail.com", "cimetiere").start()
        print(info)
